	    ...
	    response = requests.get(url)
			...
			if curr_class == 1 and ('img'+str(imagenum)) in self.jitter_numbers:
		        ...
		        #jitter down
				        ...
				        curr_y_tmp = curr_y
				            ...
				            #pics_created += 1
		        	            curr_y_tmp = curr_y_tmp + jitter_step
                    		            (low_x, low_y, high_x, high_y), Top, Bottom, Left, Right = get_image_dims(curr_x, curr_y_tmp, w, h)
						...
						crop = im.crop((curr_x, low_y, high_x, high_y))
						stretch = im.crop((low_x, low_y, curr_x, high_y))
						...
						crop = im.crop((low_x, low_y, curr_x+298, high_y))
						stretch = im.crop((curr_x+298, low_y, high_x, high_y))
						stretch = stretch.resize((300, 898))
						croppedim = Image.new('RGB', (898, 898))
						...
						crop = im.crop((low_x, curr_y_tmp, high_x, high_y))
						stretch = im.crop((low_x, low_y, high_x, curr_y_tmp))
						...
						crop = im.crop((low_x, low_y, high_x, curr_y_tmp+298))
						stretch = im.crop((low_x, curr_y_tmp+298, high_x, high_y))
						stretch = stretch.resize((898, 300))
						croppedim = Image.new('RGB', (898, 898))
					    ...
					    if not ((Left and Top) or (Left and Bottom) or (Right and Top) or (Right and Bottom)):
		        ...
		        #jitter right
			            ...
			            if curr_class == 1:
				            ...
				            #pics_created += 1
		        	            curr_x_tmp = curr_x_tmp + jitter_step
                    		            ...
                    		            (low_x, low_y, high_x, high_y), Top, Bottom, Left, Right = get_image_dims(curr_x_tmp, curr_y, w, h)

					    #Done?
                    		            if not (Top or Bottom or Left or Right):
					        croppedim = im.crop((low_x, low_y, high_x, high_y))
					    if Left and not (Top or Bottom):
						crop = im.crop((curr_x_tmp, low_y, high_x, high_y))
						stretch = im.crop((low_x, low_y, curr_x_tmp, high_y))
						stretch = stretch.resize((300, 898))
						croppedim = Image.new('RGB', (898, 898))
						croppedim.paste(stretch, (0, 0, 300, 898))
						croppedim.paste(crop, (300, 0, 898, 898))
					    ...
					    if Right and not (Top or Bottom):
						crop = im.crop((low_x, low_y, curr_x_tmp+298, high_y))
						stretch = im.crop((curr_x_tmp+298, low_y, high_x, high_y))
						stretch = stretch.resize((300, 898))
						croppedim = Image.new('RGB', (898, 898))
						croppedim.paste(stretch, (598, 0, 898, 898))
						croppedim.paste(crop, (0, 0, 598, 898))
					    ...
					    #Done but check that dimensions are really 898 and if its ok to start low_x at 1
					    if Top and not (Left or Right):
						crop = im.crop((low_x, curr_y, high_x, high_y))
						stretch = im.crop((low_x, low_y, high_x, curr_y))
						stretch = stretch.resize((898, 300))
						croppedim = Image.new('RGB', (898, 898))
						croppedim.paste(stretch, (0, 0, 898, 300))
						croppedim.paste(crop, (0, 300, 898, 898))
					    ...
					    if Bottom and not (Left or Right):
						crop = im.crop((low_x, low_y, high_x, curr_y+298))
						stretch = im.crop((low_x, curr_y+298, high_x, high_y))
						stretch = stretch.resize((898, 300))
						croppedim = Image.new('RGB', (898, 898))
						croppedim.paste(stretch, (0, 598, 898, 898))
						croppedim.paste(crop, (0, 0, 898, 598))
		        ...
		        #jitter diagonal
			            ...
			            if curr_class == 1:
			                ...
			                curr_y_tmp = curr_y + jitter_step
                    		        ...
                    		        (low_x, low_y, high_x, high_y), Top, Bottom, Left, Right = get_image_dims(curr_x_tmp, curr_y_tmp, w, h)
